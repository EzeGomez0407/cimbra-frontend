  ...
  return (
    <ScrollView showsVerticalScrollIndicator={false}>
      <View style={{ gap: 5, marginTop: 30 }}>
        ...
        <Text className="text-[#225599] text-base">Completa tus datos para registrarte</Text>
      </View>

      <View className="mt-3xl gap-2">
        {/* INPUT NAMES */}
        <TextInput onChangeText={(value)=>onChange('name', value)}
          mode="outlined"
        ...
        {/* INPUT LASTNAMES */}
        <TextInput onChangeText={(value)=>onChange('lastname', value)}
          mode="outlined"
        ...
        {/* INPUT EMAIL */}
        <TextInput onChangeText={(value)=>onChange('email', value)}
          mode="outlined"
        ...
        {/* INPUT PASSWORD */}
        <TextInput onChangeText={(value)=>onChange('password', value)}
          mode="outlined"
